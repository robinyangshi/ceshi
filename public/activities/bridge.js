var HybridApi = {
    ...
    initHySaveImage:function(){//长按保存图片Api
        var postNativeMsg = function(value){
            if( HybridApi.getQueryParams('platform')==='android' ){
            ...
            }else if( HybridApi.getQueryParams('platform')==='ios' ){
    ...
    getUserPreference:function(){
        ...
        try {
            ...
            if( self.getQueryParams('platform')==='android' ){
            ...
            }else if( self.getQueryParams('platform')==='ios' ){
